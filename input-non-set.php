...
$Data_NonSET = mysqli_query($conn, "SELECT * 
  FROM tbl_transac 
  WHERE status_transac = 'For_Validation' 
    AND ncvs = '$ncvs' AND status_set = 'NON-SET'
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Input data Stock NON SET</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form action="function.php" method="POST">
                <div class="card-body">
                    ...
                    <input type="text" name="status_set" hidden   value="NON-SET">
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control select2" name="category" style="width: 100%;">
                        ...
                        <option value="SA.UPR">Upper</option>
                        <option value="SA.BTM">Outsole</option>
                        <option value="SA.UTS">Texon</option>
                        <option value="SA.UCI">Insole</option>
                      </select>
                    </div>
                    <div class="form-group">
                ...
                <div class="card-footer">
                  <button type="submit" name="NonSet-submit" class="btn btn-primary">Submit</button>
                </div>
              </form>
            </div>
            <!-- /.card -->
            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                  <?php $no = 1; ?>
                  <?php foreach ($Data_NonSET as $data): ?>
                  <tr>
                    <td><?= $no++; ?></td>
                    <td><?= $data['ncvs']; ?></td>
                    <td><?= $data['area']; ?></td>
                    ...
                    <td class="text-center">
                      <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right"
                          ...
                          <a class="dropdown-item editNonSet"
                            data-toggle="modal"
                            data-target="#editInputNONSet"
                          ...
                          <form action="function.php" method="post"
                            ...
                            <button type="submit" name="delete-nonset" class="dropdown-item text-danger">
        ...
        <div class="modal fade" id="editInputNONSet" tabindex="-1" role="dialog">
          <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
            <div class="modal-content">

              <div class="modal-header bg-light">
                <h5 class="modal-title">
                  <i class="fas fa-edit mr-2"></i> Edit Data NON SET
                </h5>
              ...
              <form action="function.php" method="POST">
                ...
                <div class="modal-footer justify-content-between">
                  ...
                  <button type="submit" name="update-nonset" class="btn btn-success">
...
<script>
  document.addEventListener("DOMContentLoaded", function () {
    ...
    document.querySelectorAll(".editNonSet").forEach(function (btn) {
