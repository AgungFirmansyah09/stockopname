...
$Data_Final = mysqli_query($conn, "SELECT * 
  FROM tbl_transac 
  WHERE status_transac = 'Final_SO' 
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Input data Final Data SO 2025</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form action="function.php" method="POST" enctype="multipart/form-data">
                    <div class="card-body">
                        ...
                        <input type="text" name="status_transac" hidden value="Final_SO">

                        <label>Upload Data Final SO</label>
                        <div class="input-group">
                            <div class="custom-file">
                                <input type="file" name="file_csv" class="custom-file-input" id="exampleInputFile" required>
                                <label class="custom-file-label" for="exampleInputFile">Choose file</label>
                            </div>
                            <div class="input-group-append">
                                <button type="submit" name="upload-final-data" class="btn btn-success">Upload</button>
                            </div>
                        </div>
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Data Final SO 2025</h3>
                </div>
                <div class="card-body">
